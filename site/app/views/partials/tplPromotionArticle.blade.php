          ...
          <article class="pageSection cmsContent">
            <div class="grid">
              <header class="col-12-20 colFirst tabCol-18-20 tabColFirst mobCol-18-20 mobColFirst">
                <h1 class="primaryHeader"><span class="subPrimaryHeader">Fashion:</span> Promotion Title</h1>
                <p class="backTo">
                  Back to: <a href="#">Fashion</a>
                  <span class="fr">
            ...
            <div class="grid">
              <div class="column col-12-20 colFirst tabCol-18-20 tabColFirst mobCol-20-20">
                ...
                <div class="fr col-75 mobCol-18-20 mobColLast">
                  ...
                  <p>Maecenas nulla erat, auctor id luctus quis, rhoncus eget eros. Sed nulla nibh, lacinia placerat est in, <a href="#">pellentesque faucibus</a> tellus. Suspendisse potenti. Integer suscipit est nunc, et posuere nunc volutpat non. Ut tincidunt nibh elementum convallis auctor. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
                  <p>Aliquam erat volutpat. Proin diam est, malesuada vel tellus a, scelerisque congue sem. Mauris enim arcu, pretium pretium adipiscing ut, feugiat eu nunc. Nullam non nulla sit amet sem aliquet vulputate. Aliquam erat volutpat. Morbi placerat erat at sem suscipit euismod. Cras vestibulum odio faucibus interdum ultrices. Vestibulum fringilla fermentum eros, vitae consequat justo consequat at. Quisque eget mi lacus.</p>
