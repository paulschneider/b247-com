...
<article class="pageSection cmsContent">
    <div class="grid">
        <header class="col-12-20 colFirst tabCol-18-20 tabColFirst mobCol-18-20 mobColFirst">
            <h1 class="primaryHeader"><span class="subPrimaryHeader">Music:</span> Thekla 30th birthday series</h1>
            <p class="backTo">
                Back to: <a href="#">Music</a>
                <span class="fr">
    ...
    <div class="grid">
        ...
        <div class="fr col-75 mobCol-18-20 mobColLast">
            <div>
                <h2>Suspendisse pellentesque tincidunt dolor adipiscing magna.</h2>
                <p class="author">Author, 00.00.00</p>

                <p>
                    Maecenas nulla erat, auctor id luctus quis, rhoncus eget eros. Sed nulla nibh, lacinia placerat est in, <a href="#">pellentesque faucibus</a> tellus. Suspendisse potenti. Integer suscipit est nunc, et posuere nunc volutpat non. Ut tincidunt nibh elementum convallis auctor. Interdum et malesuada fames ac ante ipsum primis in faucibus.
                </p>
                <p>
                    Aliquam erat volutpat. Proin diam est, malesuada vel tellus a, scelerisque congue sem. Mauris enim arcu, pretium pretium adipiscing ut, feugiat eu nunc. Nullam non nulla sit amet sem aliquet vulputate. Aliquam erat volutpat. Morbi placerat erat at sem suscipit euismod. Cras vestibulum odio faucibus interdum ultrices. Vestibulum fringilla fermentum eros, vitae consequat justo consequat at. Quisque eget mi lacus.
                </p>
            </div>
        </div>
        ...
        <div class="fr col-75 mobCol-18-20 mobColLast cmsSecondaryContent">
            ...
            <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut tempus mauris. Etiam risus enim, cursus ut nulla a, scelerisque ornare enim. Ut magna sed <a href="#">tempor commodo arcu ut</a> aliquet. Donec at lacus auctor, dictum lacus ornare, hendrerit enim. Proin viverra, odio et varius porttitor, dolor nisl mollis magna, sit amet iaculis augue metus sed sem. Suspendisse ac egestas lacus. In aliquam ultricies mollis, lobortis quis urna eget, mollis placerat ligula. Duis accumsan lorem nec massa condimentum ullamcorper. Cras et eros lectus.
            </p>

            <p>
                Sed magna nunc, eleifend at nunc elementum, malesuada consectetur leo. Vivamus pharetra dui ut viverra blandit. Cras feugiat consequat rutrum. Nunc vehicula tempor dolor, porttitor venenatis lectus placerat ut. Mauris bibendum ornare nisi, eget congue quam facilisis nec.
            </p>
