...
<!-- SEO/Social -->
    ...
    <!-- Open Graph -->
    <meta property="og:image" content="{{ assetPath() }}i/icons/opengraph.png" />
    ...
    <meta name="twitter:image" content="{{ assetPath() }}i/icons/twitter-card.png"> 
...
<!-- Icons -->
    ...
    <meta name="msapplication-TileImage" content="{{ assetPath() }}i/icons/favicon-144.png">
    <!-- Opera speed dial / Opera Coast icon -->
    <link rel="icon" sizes="195x195" href="{{ assetPath() }}i/icons/favicon-195.png">
    <link rel="icon" sizes="228x228" href="{{ assetPath() }}i/icons/favicon-228.png">
    <!-- For iPad with high-resolution Retina display running iOS = 7: -->
    <link rel="apple-touch-icon-precomposed" sizes="152x152" href="{{ assetPath() }}i/icons/favicon-152.png">
    <!-- For iPad with high-resolution Retina display running iOS = 6: -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ assetPath() }}i/icons/favicon-144.png">
    <!-- Chrome web store -->
    <link rel="apple-touch-icon-precomposed" sizes="128x128" href="{{ assetPath() }}i/icons/favicon-128.png">
    <!-- For iPhone with high-resolution Retina display running iOS = 7: -->
    <link rel="apple-touch-icon-precomposed" sizes="120x120" href="{{ assetPath() }}i/icons/favicon-120.png">
    <!-- For iPhone with high-resolution Retina display running iOS = 6: -->
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{ assetPath() }}i/icons/favicon-114.png">
    <!-- Google TV -->
    <link rel="apple-touch-icon-precomposed" sizes="96x96" href="{{ assetPath() }}i/icons/favicon-96.png">
    <!-- For first- and second-generation iPad: -->
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{ assetPath() }}i/icons/favicon-72.png">
